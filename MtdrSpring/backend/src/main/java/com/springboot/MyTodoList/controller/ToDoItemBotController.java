...
public class ToDoItemBotController extends TelegramLongPollingBot {
    ...
    public ToDoItemBotController(String botToken, String botName, ToDoItemService toDoItemService, UserAuthentication userAuthentication) {
        ...
        this.userAuthentication = userAuthentication;  // Inyecta la instancia de UserAuthentication
    }
    ...
    private void handleDoneCommand(long chatId, String messageTextFromTelegram) {
    ...
    private void handleUndoCommand(long chatId, String messageTextFromTelegram) {
    ...
    private void handleDeleteCommand(long chatId, String messageTextFromTelegram) {
    ...
    private void handleListAllItemsCommand(long chatId) {
    ...
    private void handleAddNewItemCommand(long chatId) {
        try {
            SendMessage messageToTelegram = new SendMessage();
            messageToTelegram.setChatId(chatId);
